// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TransactionalDbContext.cs" company="Strato Systems Pty. Ltd.">
...
namespace Strato.Persistence.EntityFrameworkCore
{
    ...
    /// <summary>
    ///     The abstract <see cref="DbContext"/> implementing <see cref="IDbContext"/> with more direct support for
